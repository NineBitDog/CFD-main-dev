...
START_MARKERS = (
    ...
    "\t// First pass: reject the seed unless its streamline is actually affected by",
...
# In field_mode==0, freestream cells are ignored completely. A cell contributes
# to the volume only when either its speed or direction differs sufficiently
# from the freestream velocity.
