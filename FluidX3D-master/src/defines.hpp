...
// Wind-tunnel startup: begin from rest and smoothly ramp the inlet to the target speed.
...
#define GRAPHICS_STREAMLINE_U_INF INLET_VELOCITY
#define GRAPHICS_STREAMLINE_SPEED_THRESHOLD 0.03f
#define GRAPHICS_STREAMLINE_DIRECTION_THRESHOLD 0.02f
