...
"""
    ...
    def compile():
        ...
        compile_cmd = (
            ...
            f'echo Compiling...\n'
            f'cl /std:c++17 /O2 /EHsc /nologo '
            f'src/main.cpp src/lbm.cpp src/setup.cpp src/graphics.cpp '
            f'src/info.cpp src/kernel.cpp src/lodepng.cpp src/shapes.cpp '
            f'/Fe:bin\\FluidX3D.exe /Fobin\\ '
            f'/I. /Isrc /Isrc\\OpenCL\\include '
            f'/link /LIBPATH:src\\OpenCL\\lib OpenCL.lib '
